...
public:
   IT_Lat_Char_2();
   bool IsMember(const G6& g) const {return (g[3] > 0.0) && (g[4] > 0.0); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[3]<=0) && (g[4]<=0) && (g[0] >= -g[3]) && (-g[3] > g[0] / 2.0) && (g[3] <= 0.0); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[3] <= 0) && (g[4] <= 0) && (-g[3] <= g[0]/2.0) && (g[3] <=0.0); }
};

class IT_Lat_Char_5 : public IT_Lat_Char_Base {
public:
   IT_Lat_Char_5();
   bool IsMember(const G6& g) { return g[3] < 0.0; }
};
...
public:
   ...
   bool IsMember(const G6& g) const { 
      ...
      const bool b3 = d1 > d2;
      return true;
      return (g[0]/2.0>=-g[5]/2.0) && (-g[5]/2.0>g[0]/3.0); 
   }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (-g[5]/2.0 <= g[0]/3.0); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[0] / 2.0 >= -g[3]/2.0) && (-g[3]/2.0 > g[0]/3.0); };
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (-g[3]/2.0 <= g[0] / 3.0); };
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (-g[4] < -g[3]) && (-g[4] + 2 * (-g[3]) < 2 * g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5] > 0) && (-g[3]+g[2]+g[0]< 2*g[0]-g[5]) && (2*g[0]-g[5] < g[3]+g[2]+g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5] > 0) && (-g[3] + g[2] + g[0] > 2 * g[0] - g[5]) && (2 * g[0] - g[2]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5] < 0) && (g[2] < 2.0*g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5] <= 0) && (g[0] < g[2] - g[5]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5]<=0) && ( (g[2]-g[5])/2 <=g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5] > 0) && (-g[4]+g[2]+g[0] < 2*g[0]-g[5]) && (2 * g[0] - g[5] < g[4]+g[2]+g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5] > 0) && (-g[4] + g[2] + g[0] >= 2 * g[0] - g[5]) && (2 * g[0] - g[5] < g[2]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[3] < 0) && (3.0*g[0] <g[2] -g[3]) && (g[3]+g[2]+g[0] < -2*g[3]); }
};
...
public:
   IT_Lat_Char_17();
   bool IsMember(const G6& g) const { return (g[3] < 0); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5] > 0) && (g[0] <=g[1]) && (g[1] < 5.0*g[0]/2.0); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5] > 0) && (g[1] >= 5.0*g[0]/2.0); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return  (g[3] > 0) && (g[0] < (g[1]-g[3])/2.0); }
};
class IT_Lat_Char_19b : public IT_Lat_Char_19 {
public:
   IT_Lat_Char_19b() : IT_Lat_Char_19() { m_ITnumber = "19b"; m_DC7_character = "[]"; };
   bool IsMember(const G6& g) const { return (g[3] > 0) && ((g[1] - g[3]) / 2.0 <= g[0]) && (g[0] < g[1]-g[3]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[3] < 0) && (g[0] < g[1] +g[3]); }
};
...
public:
   IT_Lat_Char_24();
   bool IsMember(const G6& g) const { return g[5] < 0; }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[3] > 0) && (g[2] < g[1]+2*g[0]) && (5*g[0]/2 < g[1]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[3] > 0) && (g[2] < g[1]+2*g[0]) && (g[1] <= 5*g[0]/2); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[4] < 0) && (g[1]-g[4] < g[2]) && (g[2]<g[1]+g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[4] < 0) && (g[2] <=g[1]-g[4]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[4] < 0) && (g[2] >=g[1]+g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[3] < 0) && (t <r + s) && (r + u < s); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[3] < 0) && (t<r+s) && (t > r + u) && (r + u >= s); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[3] < 0) && (t < r+s) && (r+u>=t); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5] < 0) && (g[2]<g[5]+g[1]+g[0]) && (g[2]+g[1]<-g[5]+g[1]+g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5] < 0) && (g[2]>=g[5]+g[1]+g[0]) && (g[2]+g[1] < -g[5]+g[2]+g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5] < 0) && (g[2] < g[5]+g[1]+g[0]) && (-g[5]+g[1]+g[0]>g[2]+g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5] < 0) && (-g[5]+g[1]+g[0] >=g[2]) && (g[2] >= g[5]+g[1]+g[0]) && (-g[5]+g[1]+g[0] < g[2]+g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[4] < 0) && (g[2] < g[1]+g[0]) && (g[1] > 2*g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[4] < 0) && (g[2]>=g[1]+g[0]) && (g[1] >=g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5] < 0) && (g[2] < 2*g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5] < 0) && (2*g[0]<g[2]) && (g[2]<g[1]+g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[5] < 0) && (g[1]+g[0] <= g[2]) && (g[2] < g[1]+2*g[0]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[1]+2*g[0]<=g[2]); }
};
...
public:
   ...
   bool IsMember(const G6& g) const { return (g[3] < 0) && (g[2] < g[1]+g[0]); }
};
