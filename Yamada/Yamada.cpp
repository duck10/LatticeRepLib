...
public:
   ...
   V2 operator- (const V2 d) const { V2 a; a.m1 = a.m1 = d.m1; a.m2 = a.m2 - d.m2; return a; }
   double norm() const { return sqrt((*this).m1*(*this).m1 + (*this).m2 - (*this).m2);; }
