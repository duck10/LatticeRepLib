...
public:
   ...
   // New P3 agreement functionality
   void SetNewP3Agreement(double p3_agreement);
   std::vector<double> GetP3Agreements(void) const { return m_P3Agreement; }
   double CalculateP3Agreement(const S6& s1, const S6& s2) const;

   // New ListOutput member function
   std::string ListOutput(const std::vector<S6>& vs, const std::string& referenceLattice) const;
...
protected: // member data
   ...
   std::vector<double> m_P3Agreement;  // New member variable
};
