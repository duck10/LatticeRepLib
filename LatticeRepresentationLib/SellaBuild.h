...
public:
   ...
   const std::map<std::string, std::vector<S6> >& SellaBuildMap() { return themap; }
...
public:
   ...
   std::set<S6> Xpand1(const std::string& label, const std::set<S6>& vs);
   std::set<S6> Xpand2(const std::string& label, const std::set<S6>& vs);
   std::set<S6> Xpand3(const std::string& label, const std::set<S6>& vs);
   std::set<S6> Xpand1(const std::string& label, const S6& vs);
   std::set<S6> Xpand2(const std::string& label, const S6& vs);
   std::set<S6> Xpand3(const std::string& label, const S6& vs);
};
