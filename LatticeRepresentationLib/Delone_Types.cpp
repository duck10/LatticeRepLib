...
//Delone_Type::Delone_Type(const std::string& deloneType, 
...
Delone_Type::Delone_Type(
   ...
   , m_freePsrams(freeParams)
{
}
//
//DeloneFitResults Delone_Type::GetFit( const S6& s6 ) const
//{
...
std::ostream& operator<< (std::ostream& o, const Delone_Type& m) {
...
Delone_Type_C1::Delone_Type_C1()
   : Delone_Type("C1", "?", "rrr rrr", "toE3", MatS6(), 1)
{
}
