...
IT_TypeList::IT_TypeList( const bool build /*=true*/) {
   if (build) {
      ...
      //m_IT_Types.push_back(std::move(std::shared_ptr<IT_Lat_Char_Base>(new IT_Lat_Char_31)));
      // IT31 is triclinic
      ...
      //m_IT_Types.push_back(std::move(std::shared_ptr<IT_Lat_Char_Base>(new IT_Lat_Char_44))); //NA
      // IT44 is triclinic
   }
}
