...
void haar_1d ( int n, std::vector<double>& x )
...
void haar_1d_inverse ( int n, std::vector<double>& x )
...
# define TIME_SIZE 40
  ...
  len = (unsigned long)std::strftime ( time_buffer, TIME_SIZE, "%d %B %Y %I:%M:%S %p", tm_ptr );
