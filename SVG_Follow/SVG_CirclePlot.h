...
private:
      ...
      /*-------------------------------------------------------------------------------------*/
   {
      ...
      for( unsigned long counter = 1; counter != angles.size( ); ++counter)
      {
   ...
   void DrawLabelsOnEndsOfRuns( const unsigned long index, const double x, const double y, const double dx, const double dy )
      /*-------------------------------------------------------------------------------------*/
   {
      m_svg.push_back(
